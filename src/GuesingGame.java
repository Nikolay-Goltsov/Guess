...
/*
 * 1- Посчитать и вывести количество попыток за всю игру. При новой игре счетчик обнулить.
 * 2- Начать игру с определенным количеством попыток. Когда попытки закончатся, 
 * то вывысти угадываемое число и сообщить что игра закончена.
 */
